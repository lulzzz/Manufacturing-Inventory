...
namespace ManufacturingInventory.Reporting.Internal {
    public static class ModuleViews {
        ...
        public static string MonthlySummaryNavigationView { get => "MonthlySummaryNavigationView"; }
        public static string MonthlySummaryMainView { get => "MonthlySummaryMainView"; }
