...
namespace ManufacturingInventory.ConsoleTesting {
    public class ConsoleTable {
        ...
        public void Write(Format format = ConsoleTesting.Format.Default) {
            switch (format) {
                case ConsoleTesting.Format.Default:
                    Console.WriteLine(ToString());
                    break;
                case ConsoleTesting.Format.MarkDown:
                    Console.WriteLine(ToMarkDownString());
                    break;
                case ConsoleTesting.Format.Alternative:
                    Console.WriteLine(ToStringAlternative());
                    break;
                case ConsoleTesting.Format.Minimal:
