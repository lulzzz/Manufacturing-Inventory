...
namespace ManufacturingInventory.Application.UseCases {
    public class AttachmentPartInstanceEdit : IAttachmentPartInstanceEditUseCase {
        private IRepository<Attachment> _repository;
        private IUnitOfWork _unitOfWork;
        private IFileService _fileService;

        public AttachmentPartInstanceEdit(IRepository<Attachment> repository, IUnitOfWork unitOfWork, IFileService fileService) {
            this._repository = repository;
            this._unitOfWork = unitOfWork;
            this._fileService = fileService;
        }

        public Task<AttachmentPartInstanceEditOutput> Execute(AttachmentPartInstanceEditInput input) {
            return null;
        }
