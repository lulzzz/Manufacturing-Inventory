...
namespace ManufacturingInventory.Application.UseCases {
    public class AttachmentPriceEdit : IAttachmentPriceEditUseCase {
        private IRepository<Attachment> _repository;
        private IUnitOfWork _unitOfWork;
        private IFileService _fileService;

        public AttachmentPriceEdit(IRepository<Attachment> repository, IUnitOfWork unitOfWork, IFileService fileService) {
            this._repository = repository;
            this._unitOfWork = unitOfWork;
            this._fileService = fileService;
        }

        public Task<AttachmentPriceEditOutput> Execute(AttachmentPriceEditInput input) {
            return null;
        }
