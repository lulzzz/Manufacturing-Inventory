...
namespace ManufacturingInventory.Application.UseCases {
    public class AttachmentPartEdit : IAttachmentPartEditUseCase {
        private IRepository<Attachment> _repository;
        private IUnitOfWork _unitOfWork;
        private IFileService _fileService;

        public AttachmentPartEdit(IRepository<Attachment> repository, IUnitOfWork unitOfWork, IFileService fileService) {
            this._repository = repository;
            this._unitOfWork = unitOfWork;
            this._fileService = fileService;
        }

        public Task<AttachmentPartEditOutput> Execute(AttachmentPartEditInput input) {
            return null;        
        }
