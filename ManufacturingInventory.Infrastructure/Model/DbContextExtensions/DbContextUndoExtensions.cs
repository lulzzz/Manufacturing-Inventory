...
namespace ManufacturingInventory.Infrastructure.Model.DbContextExtensions {
    public static class DbContextUndoExtensions {

        public static void DetatchAll(this DbContext context) {
        ...
        public static async Task UndoAsync(this DbContext context) {
            if (context == null)
                throw new ArgumentNullException();
